package com.houkunlin.system.common.aop.ip;

import com.houkunlin.system.common.aop.AllowIPConfigurationProperties;
...
public class AllowIPAspect implements InitializingBean {
    ...
    @Before("@annotation(com.houkunlin.system.common.aop.annotation.AllowIP) || @within(com.houkunlin.system.common.aop.annotation.AllowIP)")
